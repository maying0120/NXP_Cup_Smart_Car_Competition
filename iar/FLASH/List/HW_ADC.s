///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.20.2.7424/W32 for ARM       18/Jun/2017  15:06:37
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  E:\飞思卡尔\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_ADC.c
//    Command line =  
//        E:\飞思卡尔\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_ADC.c -D LPLD_K60 -D
//        USE_K60F12 -lCN
...
//    List file    =  
//        E:\飞思卡尔\LPLD_OSKinetis_V3\project\chase_after0615（环岛跟随+环岛超车+直道超车get）备份\iar\FLASH\List\HW_ADC.s
//
///////////////////////////////////////////////////////////////////////////////
...
// E:\飞思卡尔\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_ADC.c
//    1 /**
//    2  * @file HW_ADC.c
...
??LPLD_ADC_Init_7:
        ...
        B.N      ??LPLD_ADC_Init_8
??LPLD_ADC_Init_13:
        LDR.W    R0,??DataTable12_8  ;; 0x4003c000
        CMP      R4,R0
        BNE.N    ??LPLD_ADC_Init_14
        MOVS     R11,#+2
        LDR.W    R0,??DataTable12_4  ;; 0x4004803c
        LDR      R0,[R0, #+0]
        ...
        B.N      ??LPLD_ADC_Init_8
??LPLD_ADC_Init_14:
        LDR.W    R0,??DataTable12_9  ;; 0x400bc000
        CMP      R4,R0
        BNE.N    ??LPLD_ADC_Init_15
        MOVS     R11,#+3
        LDR.W    R0,??DataTable12_7  ;; 0x40048030
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x10000000
...
//  163   //配置ADC时钟
//  164   if(adcx == ADC0)
        LDR.W    R1,??DataTable12_3  ;; 0x4003b000
        CMP      R0,R1
...
??LPLD_ADC_Deinit_2:
        ...
        BX       LR               ;; return
??LPLD_ADC_Deinit_0:
        LDR.W    R1,??DataTable12_6  ;; 0x400bb000
        CMP      R0,R1
...
??LPLD_ADC_Deinit_3:
        LDR.W    R1,??DataTable12_8  ;; 0x4003c000
        CMP      R0,R1
        ...
        B.N      ??LPLD_ADC_Deinit_1
??LPLD_ADC_Deinit_4:
        LDR.W    R1,??DataTable12_9  ;; 0x400bc000
        CMP      R0,R1
...
??LPLD_ADC_Chn_Enable_0:
        LDR.W    R3,??DataTable12_3  ;; 0x4003b000
        CMP      R0,R3
...
??LPLD_ADC_Chn_Enable_4:
        ...
        MOVS     R0,#+0
        LDR.W    R1,??DataTable12_10  ;; 0x4004b008
        STR      R0,[R1, #+0]
...
??LPLD_ADC_Chn_Enable_5:
        ...
        MOVS     R0,#+0
        LDR.W    R1,??DataTable12_11  ;; 0x4004c004
        STR      R0,[R1, #+0]
...
??LPLD_ADC_Chn_Enable_2:
        LDR.N    R3,??DataTable12_6  ;; 0x400bb000
        CMP      R0,R3
...
??LPLD_ADC_Chn_Enable_26:
        MOVS     R0,#+0
        LDR.N    R2,??DataTable12_12  ;; 0x40049000
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        STR      R0,[R2, R1, LSL #+2]
        B.N      ??LPLD_ADC_Chn_Enable_15
...
??LPLD_ADC_Chn_Enable_19:
        LDR.N    R3,??DataTable12_8  ;; 0x4003c000
        CMP      R0,R3
...
??LPLD_ADC_Chn_Enable_31:
        LDR.N    R3,??DataTable12_9  ;; 0x400bc000
        CMP      R0,R3
...
??LPLD_ADC_Chn_Enable_45:
        MOVS     R0,#+0
        LDR.N    R1,??DataTable12_13  ;; 0x40049018
        STR      R0,[R1, #+0]
        B.N      ??LPLD_ADC_Chn_Enable_15
??LPLD_ADC_Chn_Enable_46:
        MOVS     R0,#+0
        LDR.N    R1,??DataTable12_14  ;; 0x4004d070
        STR      R0,[R1, #+0]
        B.N      ??LPLD_ADC_Chn_Enable_15
...
??LPLD_ADC_Chn_Enable_49:
        MOVS     R0,#+0
        LDR.N    R1,??DataTable12_15  ;; 0x4004902c
        STR      R0,[R1, #+0]
        B.N      ??LPLD_ADC_Chn_Enable_15
